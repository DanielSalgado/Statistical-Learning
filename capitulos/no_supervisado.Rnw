...
library(xtable)
xtable(head(iris[,2:ncol(iris)]))
@

R tiene una funcion kmeans() para realizar este tipo de analisis, en este caso sabemos el valor de $K$ ya que el conjunto de datos Iris solamente contiene información de tres especies de flores. 
...
<<test, out.width='5.5cm', out.height='5.5cm', fig.show='hold', tidy=TRUE, fig.align='center', echo=FALSE>>=
